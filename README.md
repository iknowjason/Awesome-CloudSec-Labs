...
| [EntraGoat](https://github.com/Semperis/EntraGoat)    | Azure | Self-hosted lab |  [Semperis](https://www.semperis.com/) |  A deliberately vulnerable Microsoft Entra ID infrastructure.  Uses Powershell Graph SDK scripts with a nice NodeJS web UI for management.  Six vulnerable attack path scenarios with solutions documented. |
